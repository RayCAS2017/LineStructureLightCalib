...
for i = 1:num_image
    [light_vp,light_cb_intersects_cord, light_insects] = get_info_in_single_frame_undistort(imageFileNames{i}, cameraParams4,0);
...
save light_plane_undistort nl d nl0 d0;
